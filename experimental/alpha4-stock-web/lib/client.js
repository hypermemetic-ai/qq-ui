window.__ModuleLoader__.load({
  id: "@hypermemetic-ai/qq-ui-alpha4-spike",
  factory: (require) => {
    var module = { exports: {} };
    ...
    const PLUGIN_ID = "@hypermemetic-ai/qq-ui-alpha4-spike";
    ...
    const THEME_SOURCE = "qq.alpha4-spike";
    ...
    class QQFeatureBoundary extends React.Component {
      ...
      componentDidCatch(error) {
        console.error("qq alpha.4 session view failed", error);
      }
    ...
    function QQSessionContent({ sessionId, useSessions }) {
      ...
      React.createElement("p", { style: { font: "600 12px/1 ui-monospace, monospace", letterSpacing: "0.12em", margin: 0 } }, "QQ CORE / ALPHA.4"),
    ...
    exports.name = "qq-ui-alpha4-spike-client";
    ...
    exports.apply = function apply(ctx) {
      ...
      ctx.effect(() => ctx.theme.overrideTokens(THEME_SOURCE, QQ_THEME_TOKENS), "qq-alpha4: theme tokens");
