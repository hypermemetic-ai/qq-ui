...
await writeFile(resolve(root, "lib/index.d.ts"), 'export declare const name = "qq-ui-alpha4-spike";\nexport declare function apply(): void;\n');
console.log(`alpha4 spike bundle built: ${bundle.length} bytes sha256:${hash}`);
