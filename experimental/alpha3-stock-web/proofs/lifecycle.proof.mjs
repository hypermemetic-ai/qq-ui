...
try {
  for (let generation = 1; generation <= 2; generation += 1) {
    ...
    assert.deepEqual([...bench.themeLayers.keys()], ["qq.alpha3-spike"]);
...
console.log("alpha3 lifecycle proof passed: activation, disposal, reapplication, shared dispatch, no stale registrations");
